...
class FavouriteViewBody extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(children: [
      ...
      if(state is GetFavoriteSuccess&&cubit.favoriteModel!.data!=null)
          Expanded(
            child: ListView.separated(itemBuilder: (context,index) =>  FavoriteListItem(
             favoriteProduct:cubit.favoriteModel!.data!.data![index].product!,
            ),
          ...
          Expanded(
            child: ListView.separated(itemBuilder: (context, index) => const FavoriteViewLoading(),
              separatorBuilder: (context, index) => const SizedBox(height: 15,),
              itemCount: 6,),
          ),
